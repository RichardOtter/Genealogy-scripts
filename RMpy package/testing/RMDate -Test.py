...
def main():
    ...
    print(RMpy.RMDate.now_RMSortDate())
    
    print("===========================================DIV50==\n")

# -- database = C:\Users\rotter\dev\Genealogy\Test Data\Sort date example DB\TEST DATA SortDates test -format_v11 -dump -reduced - Copy.rmtree
# 
#   SELECT '    ('|| EventID|| ', ',
...
#  Dates  All sort dates same as reg date except Quaker, Quarter, double ??
...
def Test(test_item):
    try:
        ...
        out_SortDate_from_RMDate = RMpy.RMDate.to_RMsort_date(in_DB_RMdate)
        out_RMDate_from_SortDate= RMpy.RMDate.from_RMsort_date(in_DB_Sortdate)
